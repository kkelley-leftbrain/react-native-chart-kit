...
export declare function genPaths(data: Array<any>, accessor: string, center: Array<number>, r: number, R: number, compute: any): {
    paths: any[];
};
export declare function linear([a, b]: [any, any], [c, d]: [any, any]): (x: any) => any;
